...
class THighlighter : public QSyntaxHighlighter
{
 ...
 private:
     ...
     QRegExp                   commentStartExpressionPython1;
     QRegExp                   commentEndExpressionPython1;
     QRegExp                   commentStartExpressionPython2;
     QRegExp                   commentEndExpressionPython2;
     bool                      commentTypeSingleQuotePython;
     QTextCharFormat           keywordFormat;
     QTextCharFormat           searchFormat;
     QTextCharFormat           classFormat;
     QTextCharFormat           singleLineCommentFormat;
     QTextCharFormat           multiLineCommentFormat;
     QTextCharFormat           multiLineCommentFormatPython;
