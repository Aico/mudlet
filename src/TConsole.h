...
public:
      ...
      void              insertLink( QString, QStringList &, QStringList &, QPoint, int, bool customFormat=false);
      void              insertLink( QString, QStringList &, QStringList &, int, bool customFormat=false);
      void              echoLink( QString & text, QStringList & func, QStringList & hint, int, bool customFormat=false);
      ...
      void              setBold( bool );
      void              setLink( QString & linkText, QStringList & linkFunction, QStringList & linkHint, int lang );
