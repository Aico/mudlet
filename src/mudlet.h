...
public:
   ...
   bool                          echoLink( Host * pHost, QString & name, QString & text, QStringList &, QStringList &, int lang, bool customFormat=false );
   void                          insertLink( Host *, QString &, QString, QStringList &, QStringList &, int, bool customFormat=false );
   ...
   bool                          setLabelClickCallback( Host *, QString &, QString &, int, TEvent * );
   ...
   void                          setLink( Host * pHost, QString & name, QString & linkText, QStringList & linkFunction, QStringList & , int lang);
